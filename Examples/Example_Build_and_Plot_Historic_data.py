...
#Set up the distortion calc by passing the folder with all the DICOMS and the sequence of interest.
ComputeNoCorrection = Compute_Distortion.DistortionCalculation(r".\TestData\TestDataNoCor" , "3D Sag T1 BRAVO") 
...
#Compute distortion on another sequence (this could be in another file)
#Set up the distortion calc by passing the folder with all the DICOMS and the sequence of interest.
ComputeDistortion = Compute_Distortion.DistortionCalculation(r".\TestData\TestDistoredData" , "3D Sag T1 BRAVO BW=15 Shim off") 
